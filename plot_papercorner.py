...
plt.savefig('paper_corner.png')
plt.savefig('paper_corner.ps')


# Add quantiles/lit values
ax1 = plt.subplot(331)
yl = ax1.get_ylim()
ax1.plot((sl_mcmc[1][1],sl_mcmc[1][1]),yl,'k-')
