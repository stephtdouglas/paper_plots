...
ax.plot(1,100,'k*',ms=12,label=r'Field stars, K5 and later')
ax.plot(1,100,'c*',ms=12,label=r'Cluster members, K5 and later',mec='c')
ax.plot(1,100,'k*',ms=12,mfc='None',label=r'Field stars, K4 and earlier')
ax.plot(1,100,'c*',ms=12,mfc='None',label=r'Cluster members, K4 and earlier',mec='c')
...
up_lim[0] = -1.1
ax.errorbar(LxLbol[champ_low & (ulim_flag==1)],eqws[champ_low & (ulim_flag==1)],up_lim,fmt=None,
    ecolor='k',color='k',lolims=True)
...
#ax.plot(LxLbol[champ_high & (ulim_flag==0)],LhaLbol[champ_high & (ulim_flag==0)],'+',
#    mec='Gray',mew=2,ms=10)
ax.errorbar(LxLbol[champ_low & (ulim_flag==0)],
    LhaLbol[champ_low & (ulim_flag==0)],
    xerr=LxLbolerr[champ_low & (ulim_flag==0)],fmt='*',
    ecolor='k',color='k',ms=12)
ax.errorbar(LxLbol[champ_high & (ulim_flag==0)],
    LhaLbol[champ_high & (ulim_flag==0)],
    xerr=LxLbolerr[champ_high & (ulim_flag==0)],fmt='*',
    ecolor='k',mec='k',mfc='None',ms=12)


ax.plot(10**(wprae['LxLbol'][pmatches_m==1]),pll[pmatch_mloc],
    'c*',ms=12,mec='c')
ax.plot(10**(wh['LxLbol'][hmatches_m==1]),hll[hmatch_mloc],
    'c*',ms=12,mec='c')
...
up_lim = np.zeros(16).reshape(2,-1)
up_lim[0] = -1.1
ax.errorbar(LxLbol[champ_low & (ulim_flag==1)],LhaLbol[champ_low & (ulim_flag==1)],LhaLbol[champ_low & (ulim_flag==1)]*0.3,fmt=None,
    ecolor='k',color='k',lolims=True)
